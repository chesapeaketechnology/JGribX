...
public class Grib2RecordPDS
{
    ...
    {
        private final Grib2Level level1;
        private final Grib2Level level2;
        ...
        public float[] getValues()
        {
            if (isSingleLayer())
            {
                return new float[]{level1.getValue()};
            }
     ...
     */
    private final Calendar forecastTime;
     ...
     */
    private final int genProcessId;
     ...
     * e.g. 2 (Forecast)
     */
    private final int genProcessType;

    private final int nCoords;

    private final int paramCategory;
    ...
    public boolean equals(Object obj)
    {
        ...
        return parameter.equals(pds.getParameter());
    }
}
